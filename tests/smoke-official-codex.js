...
(async()=>{
 ...
 try {
   ...
   assert.equal(account.account,null,'Fresh CLI must not inherit an account');
   const result={passed:true,version,initialize:true,account:'not_logged_in',modelInvoked:false};
