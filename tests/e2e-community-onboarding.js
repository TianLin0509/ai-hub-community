...
async function main(){
 ...
 async function start(){
  ...
  hub=await launchIsolatedHub({dataDir:data,port,windowMode:'hidden',extraEnv:env,...(packaged?{executablePath:path.resolve('dist/win-unpacked/AI Hub Community.exe')}:{})});
